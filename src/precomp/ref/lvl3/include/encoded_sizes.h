...
#define UNCOMPRESSED_LONG_TWO_ISOG_ENCODED_BYTES 960
...
#define SMART_SIGNATURE_LEN 257
#define UNCOMPRESSED_SIGNATURE_LEN 1056
#define PARALLEL_SIGNATURE_LEN 1248
