...
#define UNCOMPRESSED_LONG_TWO_ISOG_ENCODED_BYTES 576
...
#define SMART_SIGNATURE_LEN 173
#define UNCOMPRESSED_SIGNATURE_LEN 640
#define PARALLEL_SIGNATURE_LEN 768
