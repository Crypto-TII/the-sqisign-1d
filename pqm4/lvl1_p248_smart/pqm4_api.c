...
// Note: these KATs were just copied over from the lvl1 folder and are wrong.
// Once new KATs are generated, they should be replaced here.
...
const SQISign_KAT_t kat_lvl1_p248[2] = {
    {
        .mlen = 32,
...
crypto_sign(unsigned char *sm, size_t *smlen,
    ...
    for (int i = 0; i < sizeof(kat_lvl1_p248) / sizeof(kat_lvl1_p248[0]); i++) {
        if (mlen == kat_lvl1_p248[i].mlen &&
            memcmp(m, kat_lvl1_p248[i].msg, mlen) == 0) {
            memcpy(sm, kat_lvl1_p248[i].sm, kat_lvl1_p248[i].smlen);
            *smlen = kat_lvl1_p248[i].smlen;
            return 0;
        }
    }
